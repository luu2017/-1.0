...
<hr />
        ...
        <div>
            ...
            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="BookID" OnRowCommand="GridView1_RowCommand" Height="70px" Width="892px" AllowSorting="True" OnPageIndexChanging="GridView1_PageIndexChanging" OnSorting="GridView1_Sorting" BackColor="LightGoldenrodYellow" BorderColor="Tan" BorderWidth="1px" CellPadding="2" ForeColor="Black" GridLines="None">
                ...
                <Columns>
                    ...
                    <asp:ButtonField ButtonType="Image" HeaderText="详情" Text="按钮" CommandName="chakan" ImageUrl="~/tupian/icon_addresslist.png" >
                    <ItemStyle Height="70px" Width="70px" />
                    </asp:ButtonField>
                </Columns>
                <FooterStyle BackColor="Tan" />
                <HeaderStyle Width="100px" BackColor="Tan" Font-Bold="True" />
